...
public class Interface extends LogicClass {
    ...
    public Scene welcomeScene() {
        ...
        start.setFont(new Font("Tw Cen MT Condensed",32));
        ...
        welcomeScene.setOnKeyPressed(event->{
                switch(event.getCode()){
                    ...
                    case ENTER:
                        welcomeButtonAndListener(tfPlayerOne, tfPlayerTwo, warning, gameStage);
                        break;
                    }
        ...
        bpnWelcome.setStyle("-fx-background-image:url(fondo3.jpg);"+
    ...
    //Método general para llamarlo en el keylistener y la acción del botón, ya que hacen lo mismo
    public void welcomeButtonAndListener(TextField tfPlayerOne,TextField tfPlayerTwo,Label warning,Stage gameStage){
    ...
    public Scene catGame() {
        ...
        playerTurn.setFont(new Font("Tw Cen MT Condensed",23));
...
//       sub menus
        ...
        bpn.setStyle("-fx-background-image:url(fondo3.jpg);"+
                        "-fx-background-position:left top,center;"+
                        "-fx-background-repeat:no-repeat;"+
                        "-fx-background-size:cover,auto;");
    ...
    public Scene showGameDescription() {
        ...
        vbDesc.setStyle("-fx-background-image:url(fondo3.jpg);"+
                        "-fx-background-position:left top,center;"+
                        "-fx-background-repeat:no-repeat;"+
                        "-fx-background-size:cover,auto;");
    ...
    public void showFirstPlayer() {
        ...
        vbFirstPlayer.setStyle("-fx-background-image:url(fondo3.jpg);"+
                        "-fx-background-position:left top,center;"+
                        "-fx-background-repeat:no-repeat;"+
                        "-fx-background-size:cover,auto;");
    ...
    public void creditsScene() {
        VBox vbContainer = new VBox();
        vbContainer.setStyle("-fx-background-image:url(fondo3.jpg);"+
                        "-fx-background-position:left top,center;"+
                        "-fx-background-repeat:no-repeat;"+
                        "-fx-background-size:cover,auto;");
        vbContainer.setAlignment(Pos.CENTER);
    ...
    public void login() { // loguearse                                                        L O G U E O 
        ...
        lB_User.setFont(new Font("Tw Cen MT Condensed",20));
        TextField tF_user = new TextField();
        tF_user.setStyle("-fx-background-color: gray; -fx-text-fill: white");
        ...
        lB_password.setFont(new Font("Tw Cen MT Condensed",20));
        TextField tF_password = new TextField();
        tF_password.setStyle("-fx-background-color: gray; -fx-text-fill: white");
        ...
        loginScene.setOnKeyPressed(event->{
                switch(event.getCode()){
                    case ENTER:
                        loginButtonAndListener(tF_user, lB_WarningMessage, tF_password, stageLogin);
                        break;
                }
    ...
    //Método general para llamarlo en el keylistener y la acción del botón, ya que hacen lo mismo
    public void loginButtonAndListener(TextField tF_user,Label lB_WarningMessage, TextField tF_password, Stage stageLogin){
